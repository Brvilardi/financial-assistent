...
DATABASES = {
    'default': {
        ...
        'NAME': customScripts.getVariableData(CREDENTIALS_PATH, "DATABASE_NAME"),
        'USER': customScripts.getVariableData(CREDENTIALS_PATH, "DATABASE_USER"),
        'PASSWORD': customScripts.getVariableData(CREDENTIALS_PATH, "DATABASE_PASSWORD"),
        'HOST': customScripts.getVariableData(CREDENTIALS_PATH, "DATABASE_HOST"),
        'PORT': '5432',
    }
}
